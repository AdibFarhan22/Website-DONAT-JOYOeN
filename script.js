...
function openMenuPopup(idx) {
  ...
  document.getElementById('popupImg').src = m.foto;
  document.getElementById('popupImgFallback').textContent = m.emoji;
  document.getElementById('popupImg').onerror = function() {
    this.style.display = 'none';
    document.getElementById('popupImgFallback').style.display = 'flex';
  };
